...
protected:
  ...
  // NOTE: These are protected to match TGS Inventor, but it seems silly to not have them public, as for the other sensors. Consider making them public before 3.0 release.
  SoSFTime enterTime;
  SoSFTime exitTime;
  SoSFBool isActive;
};
