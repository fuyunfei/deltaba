...
#ifndef COIN_SOWINLEAVESCOPE_H
#define COIN_SOWINLEAVESCOPE_H

// This is just a dummy file to be sourcecode compatible with TGS'
// Inventor on MSWindows platforms. See the comment in the
// SoWinEnterScope.h file for the full story.
